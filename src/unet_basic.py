...
def get_model():
    ...
    c2 = Conv2D(64, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (p1)
    c2 = Conv2D(64, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c2)
    c2 = Conv2D(64, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c2)
    p2 = MaxPooling2D((2, 2)) (c2)

    c3 = Conv2D(128, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (p2)
    c3 = Conv2D(128, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c3)
    c3 = Conv2D(128, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c3)
    p3 = MaxPooling2D((2, 2)) (c3)

    c4 = Conv2D(256, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (p3)
    c4 = Conv2D(256, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c4)
    c4 = Conv2D(256, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c4)
    p4 = MaxPooling2D((2, 2)) (c4)

    c5 = Conv2D(512, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (p4)
    c5 = Conv2D(512, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c5)
    c5 = Conv2D(512, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (c5)
    p5 = MaxPooling2D((2, 2)) (c5)
    
    c55 = Conv2D(1024, (3, 3), strides=1,activation=activation, kernel_initializer='he_normal', padding='same') (p5)
...
best_model_fname='weights.03-0.06.hdf5'
